...
$qry_cat = $pdo->query("SELECT COUNT(*) as num FROM tbl_category");
$total_category = $qry_cat->fetch(PDO::FETCH_ASSOC);
$total_category = $total_category['num'];

$qry_video = $pdo->query("SELECT COUNT(*) as num FROM tbl_video");
$total_video = $qry_video->fetch(PDO::FETCH_ASSOC);
