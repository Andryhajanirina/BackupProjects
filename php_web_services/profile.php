	...
	if(isset($_POST['submit']))
	{
		if($_FILES['image']['name']!="")
		 {		
				...
				$img_res = $pdo->query('SELECT * FROM tbl_admin WHERE id='.$_SESSION['id'].'');
			    ...
			    if($img_res_row['image']!="")
		        {
				   ...
				   $tpath1='images/'.$image;
					...
					$data = array( 
							    ...
							    'password'  =>  md5($_POST['password']), //nanao modification teo za mdp = admin par défaut si l'utilisateur n'a pas changé
							    'email'  =>  $_POST['email'],
							    'image'  =>  $image
							    );
		 ...
		 else
		 {
					$data = array( 
							    'username'  =>  $_POST['username'],
							    'password'  =>  md5($_POST['password']), //nanao modification teo za
							    'email'  =>  $_POST['email'] 
							    );
