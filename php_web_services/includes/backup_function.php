...
function adminUser($username, $password){
    ...
    $result = $mysqli->query("SELECT id,username FROM tbl_admin where username = '".$username."' and password = '".md5($password)."'");
...
function Insert($table, $data){
   ...
   //exit;  
    ...
    $mysqli->query("INSERT INTO $table(".implode(",",$fields).") VALUES ('".implode("','", $values )."');") or die( $mysqli->error );
}
