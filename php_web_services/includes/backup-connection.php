<?php
	// error_reporting(0); // En prod
	error_reporting(E_ERROR | E_WARNING | E_PARSE | E_NOTICE); // En dev
	ob_start();
    session_start();
 	...
 	header("Content-Type: text/html;charset=UTF-8");
		...
		if($_SERVER['HTTP_HOST']=="localhost" or $_SERVER['HTTP_HOST']=="192.168.1.125" or $_SERVER['HTTP_HOST']=="192.168.88.166")
		{	
			//local  
